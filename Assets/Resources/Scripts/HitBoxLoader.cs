...
public class BrawlCollider
{
    ...
    public BrawlCollider(BoxCollider2D b, bool type, int i)
    {
        id = i;
        boxtype = type;
        box = b;
    ...
    //setters and getters
    public void setBox(BoxCollider2D b)
    {
        b = box;
    }
    ...
    public void setBox(BoxCollider2D b, bool type)
    {
        b = box;
        boxtype = type;
    }
    public void setBox(BoxCollider2D b, int i)
    {
        b = box;
        id = i;
    }
    public void setBox(BoxCollider2D b, bool type, int i)
    {
        b = box;
        boxtype = type;
        id = i;
...
public class BrawlManager : MonoBehaviour
{
    ...
    public void updateBoxes(BoxCollider2D[] newboxes)
    {
    ...
    public void addBox(BoxCollider2D b, bool type)
    {
...
public class HitBoxLoader : MonoBehaviour
{
    ...
    void Update()
    {
        if(frame!= anim.getFrame() || !anim.getSprite().Equals(box) || !anim.getPath().Equals(path))
        {
            ...
            box = anim.getSprite();
            frame = anim.getFrame();
            if(anim.getSprite().Equals("sting2"))
            Debug.Log("tes");
            UpdateBoxes();
        }
    }
